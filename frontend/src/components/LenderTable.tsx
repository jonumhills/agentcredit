                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <a href={`${EXPLORER}/address/${lender.lender}`} target="_blank" rel="noreferrer"
                      className="text-white font-medium font-mono hover:text-okx-blue transition-colors">
                      {short(lender.lender)}
                    </a>
...
function ScorePill({ score }: { score: number }) {
  const cls = score >= 81 ? "tag-green" : score >= 61 ? "tag-blue" : score >= 41 ? "tag-yellow" : "tag-red";
